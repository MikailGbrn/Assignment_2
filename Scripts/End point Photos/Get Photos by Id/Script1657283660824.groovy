...
response = WS.sendRequest(findTestObject('Photos/Get Photos by Id'))
...
WS.verifyElementPropertyValue(response, 'thumbnailUrl', 'https://via.placeholder.com/150/b6823f')
